  ...
  return (
    <aside className='fixed top-0 right-0 w-[300px] h-screen p-4 bg-green-500 text-white flex flex-col gap-4'>
        <div className='flex justify-between items-center'>
            <Link to='/' >
                <h2 className='uppercase bg-black px-2 py-4 text-sm rounded'>write in</h2>
            </Link>
            <FaPlus className='rotate-45 text-3xl text-red-700 cursor-pointer bg-transparent' onClick={()=>setIsActive(false)}/>
        </div>
