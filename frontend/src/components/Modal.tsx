...
const Modal = ({message, handleExecute, handleCancel}:Props) => {
    return (
        <div className="fixed z-[100] inset-0 w-full h-full bg-[rgba(0,0,0,.5)] grid place-items-center">
            <div className="max-w-lg mx-auto bg-white p-5 rounded flex flex-col gap-3">
               <h2 className="text-xl font-bold">Are you sure you want to perform this action?</h2> 
               <div>
